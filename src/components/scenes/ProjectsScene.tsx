  ...
  return (
    <motion.div
      ...
      className={`relative rounded-2xl flex flex-col justify-between p-6 md:p-8 bg-midnight-navy/50 border transition-all duration-300 shadow-2xl overflow-hidden group select-none ${
        project.isHero
          ? "w-full max-w-[340px] min-h-[430px] sm:max-w-[400px] md:max-w-[456px] md:h-[576px] border-electric-cyan border-2 z-20"
          : "w-full max-w-[300px] min-h-[380px] sm:max-w-[350px] md:max-w-[380px] md:h-[480px] border-electric-cyan/15 hover:border-electric-cyan/60 z-10"
      }`}
      animate={{
        boxShadow: isHovered
